...
from preprocessing_utils.B.decoding import decode_B_WGAN_GP
...
tuner = kt.RandomSearch(
    ...
    max_trials=1,  # ! THIS NUMBER IS THE MOST IMPORTANT. DON'T MAKE IT TOO HIGH!
