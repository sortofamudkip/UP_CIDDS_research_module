...
preprocessed_data_dir = (
    ...
    / "preprocessed/external/B/crossval"
).resolve()

fold_fnames = [
    (
        preprocessed_data_dir / "X_y_2c_B_fold1_train",
        preprocessed_data_dir / "X_y_2c_B_fold1_test",
    ),
    (
        preprocessed_data_dir / "X_y_2c_B_fold2_train",
        preprocessed_data_dir / "X_y_2c_B_fold2_test",
    ),
    (
        preprocessed_data_dir / "X_y_2c_B_fold3_train",
        preprocessed_data_dir / "X_y_2c_B_fold3_test",
    ),
]
